...
from vitadex.panels.dashboard_panel import dashboard_panel
from vitadex.panels.renderer import PanelRenderer
from vitadex.panels.task_panel import task_panel
...
class PanelService:
    ...
    def serve_static(self) -> Path:
        ...
        html = f"""<!doctype html>
<html lang="en"><head><meta charset="utf-8"><title>VitaDex Panels</title></head>
<body><h1>VitaDex Panels</h1><p>Local only: 127.0.0.1. Do not expose on a public network.</p><ul>{items}</ul></body></html>
"""
